...
latex_documents = [
    (master_doc, 'IsogeotoOffice.tex', 'Isogeo to Office Documentation',
     'Isogeo to Office', 'manual'),
]
...
man_pages = [
    (master_doc, 'isogeotooffice', 'Isogeo to Office Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IsogeotoOffice', 'Isogeo to Office Documentation',
     author, 'IsogeotoOffice', 'One line description of project.',
     'Miscellaneous'),
]
