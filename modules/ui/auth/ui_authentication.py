...
class Ui_dlg_form_auth_prompt(object):
    def setupUi(self, dlg_form_auth_prompt):
        ...
        self.ent_app_secret.setPlaceholderText("a1b23c4d5f6g7h8i9j10kl11mn13op148957426ft4...")
        self.ent_app_secret.setObjectName("ent_app_secret")
        self.gridLayout_2.addWidget(self.ent_app_secret, 3, 3, 1, 1)
        self.textEdit = QtWidgets.QTextEdit(self.grb_connection_ready)
        self.textEdit.setObjectName("textEdit")
        self.gridLayout_2.addWidget(self.textEdit, 0, 3, 1, 1)
        self.toolButton = QtWidgets.QToolButton(self.grb_connection_ready)
    ...
    def retranslateUi(self, dlg_form_auth_prompt):
        ...
        self.ent_app_id.setPlaceholderText(_translate("dlg_form_auth_prompt", "isogeotooffice-org-a1b23c4d5f6g7h8i9j10kl11mn13op14..."))
        ...
        self.toolButton.setText(_translate("dlg_form_auth_prompt", "..."))
        self.grb_need_account.setTitle(_translate("dlg_form_auth_prompt", "Don\'t have an account yet ?"))
        self.btn_account_new.setText(_translate("dlg_form_auth_prompt", "Request application access"))
        self.lbl_access_conditions.setText(_translate("dlg_form_auth_prompt", "<html><head/><body><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Completely free to access generic Open Data </li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Completely free to work with 20 of your geographic data and services (Isogeo account required) </li><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Ask for our annual plans to work with your whole geographic data and services ! </li></ul></body></html>"))
