...
class Ui_dlg_authentication(object):
    def setupUi(self, dlg_authentication):
        ...
        dlg_authentication.resize(700, 415)
        dlg_authentication.setMinimumSize(QtCore.QSize(700, 415))
        dlg_authentication.setMaximumSize(QtCore.QSize(700, 415))
        icon = QtGui.QIcon()
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/authentication/user.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btn_ok_cancel.setMinimumSize(QtCore.QSize(200, 30))
        self.btn_ok_cancel.setMaximumSize(QtCore.QSize(16777215, 35))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/save.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_ok_cancel.setIcon(icon2)
        self.btn_ok_cancel.setAutoDefault(False)
        ...
        self.btn_browse_credentials = QtWidgets.QPushButton(self.grb_connection_ready)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/authentication/upload.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_browse_credentials.setIcon(icon3)
        self.btn_browse_credentials.setIconSize(QtCore.QSize(16, 16))
        self.btn_browse_credentials.setCheckable(False)
        self.btn_browse_credentials.setDefault(True)
        ...
        self.btn_account_new.setMinimumSize(QtCore.QSize(200, 25))
        self.btn_account_new.setMaximumSize(QtCore.QSize(700, 35))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.btn_account_new.setFont(font)
        self.btn_account_new.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_account_new.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        ...
        self.btn_account_new.setAutoDefault(False)
        self.btn_account_new.setDefault(False)
        self.btn_account_new.setFlat(False)
    ...
    def retranslateUi(self, dlg_authentication):
        ...
        self.btn_account_new.setToolTip(_translate("dlg_authentication", "Open request form into the default web browser"))
