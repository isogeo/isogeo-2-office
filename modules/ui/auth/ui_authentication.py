...
class Ui_dlg_authentication(object):
    def setupUi(self, dlg_authentication):
        ...
        self.btn_ok_cancel.setEnabled(False)
        ...
        self.gridLayout_2.addWidget(self.btn_ok_cancel, 6, 0, 1, 6)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/authentication/upload.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_browse_credentials.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/authentication/send-o.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btn_ok_cancel.accepted.connect(dlg_authentication.accept)
        self.btn_ok_cancel.rejected.connect(dlg_authentication.reject)
