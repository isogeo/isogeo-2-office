...
class Ui_dlg_credits(object):
    def setupUi(self, dlg_credits):
        ...
        dlg_credits.setWindowModality(QtCore.Qt.ApplicationModal)
        dlg_credits.resize(375, 400)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(dlg_credits.sizePolicy().hasHeightForWidth())
        dlg_credits.setSizePolicy(sizePolicy)
        dlg_credits.setMinimumSize(QtCore.QSize(375, 400))
        dlg_credits.setMaximumSize(QtCore.QSize(375, 400))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/credits/gavel.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.lbl_isogeo_logo.setPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/credits/isogeo.png"))
        ...
        self.lbl_isogeo_punchline.setText("<html><head/><body><p><a href=\"https://www.isogeo.com\"><span style=\" color:#6480a7;\">Easy access </span></a></p><p><a href=\"https://www.isogeo.com\"><span style=\" color:#6480a7;\">to geodata!</span></a></p></body></html>")
        ...
        self.ico_github.setPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/credits/github.svg"))
        ...
        self.gridLayout_4.addWidget(self.ico_github, 0, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lbl_source_repository, 1, 0, 1, 1)
        ...
        self.ico_lgplv3.setPixmap(QtGui.QPixmap(":/IsogeoToOffice/resources/credits/lgplv3.png"))
