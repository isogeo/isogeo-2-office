...
class SystrayMenu(QSystemTrayIcon):
    ...
    def __init__(self, parent=None, caption="Isogeo To Office"):
        ...
        self.act_show = QAction(QIcon("resources/systray/window-restore.svg"),
                                      self.tr("Show"), self)
        self.act_hide = QAction(QIcon("resources/systray/window-minimize.svg"),
                                self.tr("Hide"), self)
        self.act_quit = QAction(QIcon("resources/systray/window-close-o.svg"),
                                self.tr("Exit"), self)
        # add actions to the menu
        self.menu.addActions([self.act_show,
                              self.act_hide,
                              self.act_quit])
